...
// PluginPost renders using the post layout.
...
// PluginPostContent renders using the post content.
func (te *Engine) PluginPostContent(w http.ResponseWriter, r *http.Request, content string, fm template.FuncMap, vars map[string]interface{}) (status int, err error) {
