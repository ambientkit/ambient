...
func TestMain(t *testing.T) {
	...
	// resp, body = doRequest(t, mux, httptest.NewRequest("GET", "/setNeighborPluginGrant", nil))
	// assert.Equal(t, http.StatusOK, resp.StatusCode)
	// assert.Equal(t, "Granted: false", string(body))
	...
	// resp, body = doRequest(t, mux, httptest.NewRequest("GET", "/setNeighborPluginGrantBad", nil))
	// assert.Equal(t, http.StatusInternalServerError, resp.StatusCode)
	// assert.Equal(t, "request does not exist for the grant\n", string(body))
}
