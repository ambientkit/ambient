...
var file_site_proto_rawDesc = []byte{
	...
	0x65, 0x6d, 0x70, 0x74, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x50, 0x0a, 0x14, 0x53,
	...
	0x75, 0x73, 0x65, 0x72, 0x6e, 0x61, 0x6d, 0x65, 0x32, 0x8a, 0x02, 0x0a, 0x04, 0x53, 0x69, 0x74,
...
var file_site_proto_goTypes = []interface{}{
	(*SiteUserLoginRequest)(nil),          // 0: ambient.protodef.SiteUserLoginRequest
	(*SiteAuthenticatedUserRequest)(nil),  // 1: ambient.protodef.SiteAuthenticatedUserRequest
	(*SiteAuthenticatedUserResponse)(nil), // 2: ambient.protodef.SiteAuthenticatedUserResponse
	(*Empty)(nil),                         // 3: ambient.protodef.Empty
}
var file_site_proto_depIdxs = []int32{
	3, // 0: ambient.protodef.Site.Load:input_type -> ambient.protodef.Empty
	0, // 1: ambient.protodef.Site.UserLogin:input_type -> ambient.protodef.SiteUserLoginRequest
	1, // 2: ambient.protodef.Site.AuthenticatedUser:input_type -> ambient.protodef.SiteAuthenticatedUserRequest
	3, // 3: ambient.protodef.Site.Load:output_type -> ambient.protodef.Empty
	3, // 4: ambient.protodef.Site.UserLogin:output_type -> ambient.protodef.Empty
	2, // 5: ambient.protodef.Site.AuthenticatedUser:output_type -> ambient.protodef.SiteAuthenticatedUserResponse
