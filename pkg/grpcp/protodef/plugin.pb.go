...
var file_plugin_proto_rawDesc = []byte{
	...
	0x32, 0xce, 0x03, 0x0a, 0x0d, 0x47, 0x65, 0x6e, 0x65, 0x72, 0x69, 0x63, 0x50, 0x6c, 0x75, 0x67,
...
var file_plugin_proto_depIdxs = []int32{
	...
	6, // 3: ambient.protodef.GenericPlugin.GrantRequests:input_type -> ambient.protodef.Empty
	4, // 4: ambient.protodef.GenericPlugin.Enable:input_type -> ambient.protodef.Toolkit
	6, // 5: ambient.protodef.GenericPlugin.Disable:input_type -> ambient.protodef.Empty
	6, // 6: ambient.protodef.GenericPlugin.Routes:input_type -> ambient.protodef.Empty
	0, // 7: ambient.protodef.GenericPlugin.PluginName:output_type -> ambient.protodef.PluginNameResponse
	1, // 8: ambient.protodef.GenericPlugin.PluginVersion:output_type -> ambient.protodef.PluginVersionResponse
	2, // 9: ambient.protodef.GenericPlugin.GrantRequests:output_type -> ambient.protodef.GrantRequestsResponse
	5, // 10: ambient.protodef.GenericPlugin.Enable:output_type -> ambient.protodef.EnableResponse
	6, // 11: ambient.protodef.GenericPlugin.Disable:output_type -> ambient.protodef.Empty
	6, // 12: ambient.protodef.GenericPlugin.Routes:output_type -> ambient.protodef.Empty
